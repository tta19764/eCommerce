...
public static class ProductErrors
{
    ...
    public static readonly Error InsufficientQuantity = new Error("Product.InsufficientQuantity", "Product quantity is insufficient");
    ...
    public static readonly Error InvalidDisplayImage = new Error("Product.InvalidDisplayImage", "Display image must be one of the product images");
    public static readonly Error InvalidSeller = new Error("Product.InvalidSeller", "Seller identifier is invalid");
    public static readonly Error InvalidCategory = new Error("Product.InvalidCategory", "Product category is invalid");
