...
namespace PaymentApi.Application.UnitTests;

/// <summary>Minimal MassTransit response wrapper used by isolated request-client handler tests.</summary>
internal sealed class TestResponse<T>(T message) : Response<T> where T : class
{
