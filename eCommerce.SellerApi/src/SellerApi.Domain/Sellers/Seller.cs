...
public sealed class Seller : Entity
{
    ...
    /// <returns>A success result, or a failure if the application is not pending.</returns>
    ...
    /// <param name="reviewedOnUtc">The current UTC time.</param>
    /// <returns>A success result, or a failure if the input is not valid.</returns>
